...
## DESCRIPTION
Reviews backend/frontend code against AC, API contract, and A2LT standards.
Verdict: APPROVED | APPROVED_MINOR | REJECTED. Findings classified CRITICAL/MAJOR/MINOR.
