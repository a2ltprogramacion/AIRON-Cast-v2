...
## DESCRIPTION
Defines complete technology stack from A2LT standards.
Input: project_type + requirements. Output: STK-{id} with stack{}, requirements_skeleton, constraints[].
