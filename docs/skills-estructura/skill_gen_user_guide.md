...
## DESCRIPTION
Generates end-user guide in Spanish: intro, primeros pasos, per-screen sections, FAQ, soporte.
No technical terms without plain-language explanation.
