...
# Agent: agent_forge
# Version: 1.0
# Pattern: High Freedom

---

## DESCRIPTION
Generates design proposals before committing to implementation.
Produces structured options with trade-offs. No code generated.
...
3. Execute generation following pattern: High Freedom
