...
CSV_CONFIG = {
    ...
    "prompt": {
        "file": "prompt.csv",
        "search_cols": ["Style Category", "Keywords", "AI Prompt Keywords", "CSS/Technical Keywords"],
        "output_cols": ["Style Category", "AI Prompt Keywords", "CSS/Technical Keywords", "Best For", "Sample Prompt", "Implementation Notes"]
    },
    "ux": {
...
def detect_domain(query):
    ...
    domain_keywords = {
        ...
        "prompt": ["prompt", "ai prompt", "css keyword", "implementation", "sample"],
