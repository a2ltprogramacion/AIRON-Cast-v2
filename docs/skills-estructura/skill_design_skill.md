...
## DESCRIPTION
Designs new SKILL.md following La Forja patterns: Deterministic, Template, Deep Domain.
Produces complete skill file with validation scripts.
