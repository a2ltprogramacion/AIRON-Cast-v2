...
## DESCRIPTION
Generates complete Django app boilerplate: models.py, serializers.py, views.py, urls.py, admin.py, apps.py.
Input: schema_id + contract_id + app_name.
