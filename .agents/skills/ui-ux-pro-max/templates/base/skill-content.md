...
| `prompt` | AI prompts, CSS keywords, implementation | glassmorphism, minimal, neon, dark mode |
| `icons` | Icon recommendations, libraries | lucide, heroicons, arrow, menu, search |
